...
FROM (SELECT *
      FROM matches
      WHERE start_time_utc > '2020-02-02 22:00:00.000000' AND
          start_time_utc < '2020-02-02 24:00:00.000000') AS matches
...
WHERE start_time_utc > '2020-02-02 22:00:00.000000' AND (name LIKE '%ATP%' OR name LIKE '%WTA%')
...
WHERE start_time_utc >= '2020-01-30 20:00:00.000000'
...
FROM (
    ...
    FROM (
        ...
        FROM match_course
        WHERE utc_time_recorded > '2020-01-30 20:00:00.000000'
...
WHERE mc.start_time_utc > '2020-01-30 20:00:00.000000' AND o.id ISNULL;
...
ON mc.bookmaker_id = o.bookmaker_id AND mc.match_bookmaker_id = o.match_bookmaker_id AND mc.set_number = o.set_number
WHERE start_time_utc > '2020-01-30 20:00:00.000000'  AND mc.utc_time_recorded ISNULL;
...
FROM bet
WHERE utc_time_recorded >= '2020-01-30 20:00:00.000000' AND result_corrected NOTNULL;
