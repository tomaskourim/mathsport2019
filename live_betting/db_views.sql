...
WHERE (name LIKE 'ATP%' or name LIKE 'WTA%') AND utc_time_recorded > '2021-02-07 15:30:00.000000'
...
FROM (SELECT *
      ...
      WHERE start_time_utc > '2021-02-07 15:00:00.000000' AND
          start_time_utc < '2021-02-07 15:30:00.000000') AS matches
...
WHERE start_time_utc > '2021-02-07 15:30:00.000000' AND (name LIKE '%ATP%' OR name LIKE '%WTA%')
ORDER BY start_time_utc;
...
WHERE start_time_utc >= '2021-02-07 15:30:00.000000'
...
WHERE match_bookmaker_id IN (
    ...
    FROM (
        ...
        FROM (
            ...
            FROM match_course
            WHERE utc_time_recorded > '2021-02-07 15:30:00.000000'
...
WHERE mc.start_time_utc > '2021-02-07 15:30:00.000000' AND o.id ISNULL;
...
WHERE match_bookmaker_id IN (
    ...
    WHERE start_time_utc > '2021-02-07 15:30:00.000000' AND mc.utc_time_recorded ISNULL EXCEPT
    SELECT match_bookmaker_id
    FROM inplay)
ORDER BY match_bookmaker_id;
...
FROM bet
WHERE utc_time_recorded >= '2021-02-07 15:30:00.000000' AND result_corrected NOTNULL;
