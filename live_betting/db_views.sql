...
FROM (SELECT *
      FROM matches
      WHERE start_time_utc > '2020-01-19 08:00:00.000000' AND
          start_time_utc < '2020-01-19 22:00:00.000000') AS matches
...
WHERE start_time_utc > '2020-01-19 17:00:00.000000'
ORDER BY start_time_utc;

-- bets overview
SELECT book_id, home, away, name AS tournament_name, sex, type, surface, start_time_utc, bet_type, match_part, odd,
    odd_corrected, probability, result, result_corrected, utc_time_recorded
...
WHERE start_time_utc >= '2020-01-19 08:00:00.000000'
...
-- match course
SELECT name, sex, type, match_bookmaker_id, home, away, start_time_utc, set_number, result, utc_time_recorded
FROM match_course
...
FROM bet
WHERE utc_time_recorded >= '2020-01-19 08:00:00.000000' AND result_corrected NOTNULL;
