...
WHERE (name LIKE 'ATP%' or name LIKE 'WTA%') AND utc_time_recorded > '2020-09-22 11:00:00.000000'
...
FROM (SELECT *
      FROM matches
      WHERE start_time_utc > '2020-09-22 11:00:00.000000' AND
          start_time_utc < '2020-09-23 22:00:00.000000') AS matches
...
WHERE start_time_utc > '2020-09-22 11:00:00.000000' AND (name LIKE '%ATP%' OR name LIKE '%WTA%')
ORDER BY start_time_utc;
...
WHERE start_time_utc >= '2020-09-22 11:00:00.000000'
...
WHERE match_bookmaker_id IN (
    ...
    FROM (
        ...
        FROM (
            ...
            FROM match_course
            WHERE utc_time_recorded > '2020-09-22 11:00:00.000000'
