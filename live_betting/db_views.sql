...
FROM (SELECT *
      FROM matches
      WHERE start_time_utc > '2020-01-17 20:00:00.000000' AND
...
WHERE start_time_utc > '2020-01-17 20:00:00.000000'
...
FROM bet
WHERE utc_time_recorded >= '2020-01-17 20:00:00.000000' AND result_corrected NOTNULL;
